...
这是一个抽象的认证流程，而整个过程中，如果不纠结于细节，其实只剩下一个AuthenticationManager 是我们没有接触过的了，这个身份管理器我们在后面的小节介绍。
在实际使用中，整个流程会变得更加的复杂，但是基本思想，和上述代码如出一辙。
...
![image](http://incdn1.b0.upaiyun.com/2017/09/28a46a9e60cbae03f6919a8e27cee331.png)
...
![image](http://incdn1.b0.upaiyun.com/2017/09/f8b1a0a9ac96a4c5b88f02aea8f099c4.png)
